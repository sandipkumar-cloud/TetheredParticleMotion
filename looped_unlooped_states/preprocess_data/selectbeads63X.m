...
if isempty(b.OK.beadsx_odd)
    ...
    for i=1:b.BAD.number
        xx_odd(1:size(b.BAD.beadsx_odd,1))=b.BAD.beadsx_odd(1:size(b.BAD.beadsx_odd,1),i);
        yy_odd(1:size(b.BAD.beadsx_odd,1))=b.BAD.beadsy_odd(1:size(b.BAD.beadsx_odd,1),i);
        xx_even(1:size(b.BAD.beadsx_odd,1))=b.BAD.beadsx_even(1:size(b.BAD.beadsx_odd,1),i);
        yy_even(1:size(b.BAD.beadsx_odd,1))=b.BAD.beadsy_even(1:size(b.BAD.beadsx_odd,1),i);
        ...
        b.BAD.xco_odd(1:(size(b.BAD.beadsx_odd,1)-(2*round((filter_drift1*25)/2))),i)=badxodd(round((filter_drift1*25)/2)+1:(size(b.BAD.beadsx_odd,1)-round((filter_drift1*25)/2)),1);
        b.BAD.yco_odd(1:(size(b.BAD.beadsx_odd,1)-(2*round((filter_drift1*25)/2))),i)=badyodd(round((filter_drift1*25)/2)+1:(size(b.BAD.beadsx_odd,1)-round((filter_drift1*25)/2)),1);
        b.BAD.xco_even(1:(size(b.BAD.beadsx_odd,1)-(2*round((filter_drift1*25)/2))),i)=badxeven(round((filter_drift1*25)/2)+1:(size(b.BAD.beadsx_odd,1)-round((filter_drift1*25)/2)),1);
        b.BAD.yco_even(1:(size(b.BAD.beadsx_odd,1)-(2*round((filter_drift1*25)/2))),i)=badyeven(round((filter_drift1*25)/2)+1:(size(b.BAD.beadsx_odd,1)-round((filter_drift1*25)/2)),1);
...
if b.BAD.number>=1
    for i=1:b.BAD.number;
        ...
        if but==2
            ...
            b.BAD.time(1:b.BAD.length(i),i)=b.time(ccc(1:b.BAD.length(i)));
            b.BAD.xx(1:b.BAD.length(i),i)=b.BAD.xco(ccc(1:b.BAD.length(i)),i);
            b.BAD.yy(1:b.BAD.length(i),i)=b.BAD.yco(ccc(1:b.BAD.length(i)),i);
            
            clear ccc
            mmx_bad(i)=mean(b.BAD.xx(1:b.BAD.length(i),i));
            mmy_bad(i)=mean(b.BAD.yy(1:b.BAD.length(i),i));
            b.BAD.xcor(1:b.BAD.length(i),i)=b.BAD.xx(1:b.BAD.length(i),i)-mmx_bad(i);
            b.BAD.ycor(1:b.BAD.length(i),i)=b.BAD.yy(1:b.BAD.length(i),i)-mmy_bad(i);
            ...
            elseif flag==1
                ...
                c.REC.time(1:b.BAD.length(i),j)=b.BAD.time(1:b.BAD.length(i),i);
                c.REC.beadsx(1:b.BAD.length(i),j)=b.BAD.xcor(1:b.BAD.length(i),i);
                c.REC.beadsy(1:b.BAD.length(i),j)=b.BAD.ycor(1:b.BAD.length(i),i);
